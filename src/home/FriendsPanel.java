...
public class FriendsPanel extends JScrollPane {
	...
	public FriendsPanel(MainFrame mainFrame) {
		...
		friendsPanels.add(new FriendsListPanel(mainFrame, "images/add-iloveimg-resized.png", "È«¼º¹®", "¾È³ç ³ª´Â È«¼º¹®ÀÌ¾ß", false));
		friendsPanels.add(new FriendsListPanel(mainFrame, "", "È«¼º¹®2", "¾È³ç ³ª´Â È«¼º¹®ÀÌ¾ß2", true));
		friendsPanels.add(new FriendsListPanel(mainFrame, "", "È«¼º¹®3", "¾È³ç ³ª´Â È«¼º¹®ÀÌ¾ß3", true));
		friendsPanels.add(new FriendsListPanel(mainFrame, "", "È«¼º¹®4", "¾È³ç ³ª´Â È«¼º¹®ÀÌ¾ß4", false));
		friendsPanels.add(new FriendsListPanel(mainFrame, "", "È«¼º¹®5", "¾È³ç ³ª´Â È«¼º¹®ÀÌ¾ß5", false));
